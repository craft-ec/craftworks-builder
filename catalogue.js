...
export const COMPONENTS = [
  ...
  { type: "profile", label: "Profile", phase: 4, primitives: ["Record"], schema: "stream",
  ...
  { type: "feed", label: "Feed", phase: 4, primitives: ["Record", "Edge"], schema: "stream",
  ...
  { type: "comments", label: "Comments", phase: 6, primitives: ["Record", "Edge"], schema: "stream",
  ...
  { type: "votes", label: "Votes", phase: 6, primitives: ["Edge"], schema: "stream",
  ...
  { type: "search", label: "Search", phase: 7, primitives: ["Record"], schema: "stream",
  ...
  { type: "vault", label: "Vault", phase: 8, primitives: ["Record"], schema: "capability",
  ...
  { type: "files", label: "File explorer", phase: 9, primitives: ["Container", "Blob"], schema: "directed tree",
  ...
  { type: "media", label: "Media player", phase: 9, primitives: ["Blob"], schema: "block ring",
  ...
  { type: "pay", label: "Pay button", phase: 10, primitives: ["Record"], schema: "state-transition",
  ...
  { type: "chat", label: "Chat", phase: 12, primitives: ["Record"], schema: "stream",
