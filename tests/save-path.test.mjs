...
await t("a tweak through saveCanvas keeps every id and touches ONE record", async () => {
  ...
  assert.deepEqual(
    ...
    { added: 0, updated: 1, removed: 0, untouched: 2 , adopted: 0, conflicts: 0, dropped: 0, restored: 0, restoredProject: false },
...
await t("THE CONTROL: a save that changes nothing writes nothing", async () => {
  ...
  assert.deepEqual(did, { added: 0, updated: 0, removed: 0, untouched: 2 , adopted: 0, conflicts: 0, dropped: 0, restored: 0, restoredProject: false },
...
await t("adding and removing components does not disturb the others", async () => {
  ...
  assert.deepEqual(did, { added: 1, updated: 0, removed: 1, untouched: 1 , adopted: 0, conflicts: 0, dropped: 0, restored: 0, restoredProject: false });
...
await t("a project reopened round-trips its ids, so the NEXT save is a diff too", async () => {
  ...
  assert.deepEqual(did, { added: 0, updated: 1, removed: 0, untouched: 0 , adopted: 0, conflicts: 0, dropped: 0, restored: 0, restoredProject: false },
